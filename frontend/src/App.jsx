    ...
    <>
      ...
      <main className="main-content">
        <section className="category-section">
          ...
          <ErrorBoundary section="System & Automation">
        ...
        <section className="category-section">
          ...
          <ErrorBoundary section="Actuators & Controls">
        ...
        <section className="category-section">
          ...
          <ErrorBoundary section="Environment Monitors">
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                <div className="grid-layout">
                  <TelemetryChart 
        ...
        <section className="category-section">
          ...
          <ErrorBoundary section="Grow Trays & Payload">
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
